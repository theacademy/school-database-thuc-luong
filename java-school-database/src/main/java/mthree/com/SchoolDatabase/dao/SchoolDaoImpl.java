    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = "SELECT courseCode, courseDesc FROM course JOIN teacher ON course.teacherId = teacher.tid WHERE dept = 'Computer Science';";
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        String sql = "SELECT dept, count(tid) teacherCount FROM teacher GROUP BY dept;";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, count(cs.student_id) numStudents FROM course c JOIN course_student cs ON c.cid = cs.course_id GROUP BY c.courseCode;";
    ...
    public void addStudentToClass() {
        ...
        String sql = "INSERT INTO course_student VALUES (123, (SELECT cid FROM course WHERE courseCode LIKE 'CS148'));";
    ...
    public void editCourseDescription() {
        ...
        String sql = "UPDATE course SET courseDesc = 'Advanced Python with Flask' WHERE courseCode LIKE 'CS305';";
    ...
    public void deleteTeacher() {
        ...
        String sql = "DELETE FROM teacher WHERE tFName LIKE 'David' AND tLName LIKE 'Mitchell';";
